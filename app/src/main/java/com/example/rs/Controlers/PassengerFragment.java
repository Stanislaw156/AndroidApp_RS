...
public class PassengerFragment extends Fragment {
    private EditText etFirstName, etLastName, etBirthDate, etNote;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        initUI(view);
        fetchPassengerProfileFromServer();
    ...
    private void initUI(View view) {
        ...
        btnSubmit.setOnClickListener(v -> {
            submitOrUpdatePassengerProfile();
            if(isEditMode) {
    ...
    private void fetchPassengerProfileFromServer() {
        String url = "http://10.0.2.2:4000/api/RS/passenger/myPassengerInfo";
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null,
                ...
                error -> {
                    Toast.makeText(getActivity(), "Chyba pri načítaní profilu pasažiera: " + error.toString(), Toast.LENGTH_SHORT).show();
                    enableEditing(true);
                    btnEdit.setVisibility(View.GONE);
                    btnSubmit.setVisibility(View.VISIBLE);
                }
    ...
    private void fillProfileFields(JSONObject profile) {
        try {
            ...
            Toast.makeText(getActivity(), "Chyba pri analyzovaní údajov profilu", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void submitOrUpdatePassengerProfile() {
        String url = isEditMode ? "http://10.0.2.2:4000/api/RS/passenger/updateMyPassengerInfo" :
                                  "http://10.0.2.2:4000/api/RS/passenger/createPassenger";
        ...
        try {
            ...
            JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(method, url, params,
                    ...
                    error -> Toast.makeText(getActivity(), "Chyba: " + error.toString(), Toast.LENGTH_SHORT).show()
            ) {
                @Override
                public Map<String, String> getHeaders() throws AuthFailureError {
                    Map<String, String> headers = new HashMap<>();
